...
//	our_dict.title_by_id.show();
	...
	*/
	...
	ifstream a;
	vector<char> buffer1;
	cout<<"Vou abrir o dict"<<endl;
	char vivit;
	a.open("word_id.txt");
	cout<<"Abri o dict e estou formando o buffer"<<endl;
	while(a.get(vivit)){
		buffer1.push_back(vivit);
	}
	serializable_map<string,string> dic;
	cout<<"Deserializarei o dict"<<endl;
	dic.deserialize(buffer1);
	our_dict.dict=dic;
	...
	char vivi;
	cout<<"Vou abrir o titles"<<endl;
	b.open("titles_by_id.txt");
	cout<<"Abri e vou dormar o map de id"<<endl;
	while(b.get(vivi)){
		buffer2.push_back(vivi);
	}
	serializable_map<string,string> id;
	cout<<"Deserializarei os ids"<<endl;
	id.deserialize(buffer2);
...
//	id.show();
  ...
  string line2;	
	...
	vector<string>  v2;
	cout<<"Vou abrir o arquivo dos vetores"<<endl;
	c.open("vector_id.txt");
	cout<<"Vou formar os vetores"<<endl;
...
//	our_dict.titles=v2;
/*	our_dict.titles={{"345","456","234"},{"234","345"},{"123","345"},{"234","000"}};
	our_dict.title_by_id["123"]="A folha";
	our_dict.title_by_id["456"]="Batalhas...";
	our_dict.title_by_id["234"]="Um anjo do c�u";
	our_dict.title_by_id["345"]="Creio em deuses";
	our_dict.title_by_id["000"]="Nenem fofinho";
	our_dict.dict["'floresta'"]="0";
	our_dict.dict["'igreja'"]="1";
	our_dict.dict["'familia'"]="2";
	our_dict.dict["'gigi'"]="3";*/
//chamando a fun��o de busca//
		string busca;
 	  	cout <<"Digite uma busca: ";
    	getline(cin >> ws,busca);
    	our_dict.search(busca);
